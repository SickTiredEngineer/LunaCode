...
<html>
	...
	<head>
		...
		<link href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.10.5/font/bootstrap-icons.css" rel="stylesheet"0>
			...
			<article>
				...
				<form action="JoinForm" method="post" class="d-flex flex-column align-items-center justify-content-center">
					...
					<div class="d-flex flex-row input-form-layout">
						...
						<input type="text" class="input-form" placeholder="집가고싶당">
						<button class="form-check-button">확인</button>
					</div>
					...
					<div class="d-flex flex-row  input-form-layout">
						...
						<input type="text" class="input-form-email" placeholder="">
						<p> @ </p>
						<input type="text" class="input-form-email" placeholder="">
					</div>
					...
					<div class="d-flex flex-row  input-form-layout">
						...
						<input type="text" class="input-form" placeholder="">
						<button class="form-check-button">파일 첨부</button>
					</div>
