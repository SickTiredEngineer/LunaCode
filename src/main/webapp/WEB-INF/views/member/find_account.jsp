						...
						<div class="d-flex flex-column">
							...
							<div id="find_id_layout" class="d-flex flex-column find-layout">
								...
								<div class="d-flex flex-row">
									...
									<input type="text" class="common-input-form find-input">
								</div>
								...
								<button type="button" class="positive-button find-button">아이디 찾기</button>
							...
							<div id="find_password_layout" class="d-flex flex-column find-layout">
								...
								<button type="button" class="positive-button find-button">비밀번호 찾기</button>
