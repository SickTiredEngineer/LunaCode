			...
			<article>
				...
				<div class="d-flex flex-row justify-content-center top-layout">
					<div class="d-flex flex-column justify-content-center">
						<h2 class="main-text">공통 코드 상세</h2>
					</div>
				</div>
							...
							<div class="d-flex flex-column main_layout">
									...
									<div class="d-flex flex-column justify-content-center align-item-center content-layout">
										...
										<div class="d-flex flex-column justify-content-center class-info-root-layout">
											...
											<div class="d-flex flex-row info-item">
												<p class=""><strong>코드값</strong> :${codeVo.code_label}</p>	
											</div>
											
											<div class="horizontal-line"></div>
											
											<div class="d-flex flex-row info-item">
												<p class=""><strong>코드 그룹</strong> :${codeVo.group_code}</p>	
											</div>
											...
											<div class="d-flex flex-row info-item">
												<p class=""><strong>등록 날짜</strong> : <fmt:formatDate value="${codeVo.create_date}" pattern="yyyy.MM.dd"/></p>
											</div>
											
											<div class="horizontal-line"></div>
											
											<div class="d-flex flex-row info-item">
												<p class=""><strong>등록인 ID</strong> : ${codeVo.creater_id}</p>
											</div>
											
											<div class="horizontal-line"></div>
											
											<div class="d-flex flex-row info-item">
												<p class=""><strong>코드 설명</strong> : ${codeVo.code_desc}</p>
											</div>
											...
											<div class="d-flex flex-row info-item">
												<p class=""><strong>사용여부</strong> : 
													<c:choose>
														<c:when test="${codeVo.using_status}">사용</c:when>
