		...
		<article>
			<div class="register-bg">
				<div class="lecture-register-card">
					...
					<form action="${pageContext.request.contextPath}/ClassRegist" id="class-regist-form" enctype="multipart/form-data" method="post">
						...
						<div class="reg-select-group">
							...
							<div class="reg-select-btns" id="difficulty-group">
								<button type="button" class="reg-toggle-btn selected" data-value="초급" aria-pressed="true">
									<span class="chk-ico" aria-hidden="true">&#10003;</span> <span>초급<br />
									<small>누구나 들을 수 있는</small></span>
								</button>
								<button type="button" class="reg-toggle-btn" data-value="중급" aria-pressed="false">
									<span class="chk-ico" aria-hidden="true">&#10003;</span> <span>중급<br />
									<small>전문 지식이 필요한</small></span>
								</button>
						...
						<div class="reg-select-group">
							...
							<div class="reg-info-vertical-table">
								<!-- 현장 강의 -->
								<div class="reg-info-vertical-table type-details"
									id="type-hyunsang" style="display: none;">
									<div class="info-row-vertical">
										<label for="audience-count" class="info-label-vertical">수강인원</label> 
										<input type="number" id="audience-count" name="audienceCount" class="input-vertical" value="30" min="1" disabled  />
									</div>
									<div class="info-row-vertical">
										<label for="lecture-room" class="info-label-vertical">강의장 선택</label> 
										<select id="lecture-room" name="lectureRoom" class="input-vertical" disabled >
											<option>강의장 A</option>
											<option>강의장 B</option>
										</select>
									</div>
									<div class="info-row-vertical">
										...
										<div class="date-range-vertical">
											<input type="date" id="start-date" name="startDate" class="input-vertical-date" disabled > 
											<span class="date-separator">~</span> <input type="date"
												  id="class_time" name="endDate" class="input-vertical-date" disabled >
										</div>
									</div>
									<div class="info-row-vertical">
										<label for="weekdays" class="info-label-vertical">요일 선택</label> 
										<select id="weekdays" name="weekdays" class="input-vertical" disabled >
											<option>월, 수, 금</option>
											<option>화, 목</option>
											<option>주말</option>
										</select>
									...
									<div class="info-row-vertical">
										...
										<select id="class-time" name="class_time" class="input-vertical" disabled >
								...
								<div class="reg-info-vertical-table type-details" id="type-live" style="display: none;">
									<div class="info-row-vertical">
										<label class="info-label-vertical">실시간 강의 URL</label> 
										<input type="url" name="onlineUrl" class="input-vertical" placeholder="강의 URL 입력" disabled  />
									</div>
									<div class="info-row-vertical">
										<label class="info-label-vertical">실시간 강의 시작일</label> 
										<input type="date" name="liveStart" class="input-vertical" disabled  />
									</div>
									<div class="info-row-vertical">
										<label class="info-label-vertical">실시간 강의 종료일</label> 
										<input type="date" name="liveEnd" class="input-vertical" disabled  />
									</div>
								</div>
								...
								<div class="price-frame">
									<div class="price-setting">
										...
										<div class="price-group sale-price">
											<span class="price-label">판매가 
											<span class="vat-info">(부가세10% 포함)</span></span>
											<div class="price-input-row">
												<span class="currency-symbol">$</span> 
