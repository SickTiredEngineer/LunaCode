        ...
        <div class="lecture-register-card">
          ...
          <div class="reg-top-row">
            <div class="reg-input-group">
              ...
              <input type="text" id="lec-title" class="reg-input" placeholder="제목을 입력하세요"> 
            </div>

            <!-- 강의 요약-->
            <div class="reg-input-group">
              <label for="lec-summary" class="reg-label">강의 요약</label>
              <input type="text" id="lec-summary" class="reg-input" placeholder="강의를 간단히 소개해 주세요">
            </div>
          </div>
          ...
          <div class="reg-select-group">
            ...
            <div class="reg-select-btns" id="type-group">
              <button type="button" class="reg-toggle-btn selected" data-value="현장" aria-pressed="true">
                <span class="chk-ico" aria-hidden="true">&#10003;</span>
                <span>현장 강의</span>
              </button>
              <button type="button" class="reg-toggle-btn" data-value="온라인" aria-pressed="false">
                <span class="chk-ico" aria-hidden="true">&#10003;</span>
                <span>온라인 강의</span>
              </button>
              <button type="button" class="reg-toggle-btn" data-value="실시간" aria-pressed="false">
                <span class="chk-ico" aria-hidden="true">&#10003;</span>
                <span>실시간 강의</span>
              </button>
            </div>
              ...
              <div class="reg-info-vertical-table type-details" id="type-hyunsang" style="display:none;">
                ...
                <div class="info-row-vertical">
                  ...
                  <div class="date-range-vertical">
                    ...
                    <input type="date" id="end-date" name="endDate" class="input-vertical-date">
                  </div>
                </div>
                <div class="info-row-vertical">
                ...
                <div class="info-row-vertical">
                  ...
                  <select id="class-time" name="classTime" class="input-vertical">
